...
StatusCode scheduler( std::vector<std::string> courseNames, ScheduleGroup & bufScheduleGroup )
{
    ...
    return scheduler( courseNames, bufScheduleGroup, NULL);
}
StatusCode scheduler( std::vector<std::string> courseNames, ScheduleGroup & bufScheduleGroup, std::string fpath )
{
