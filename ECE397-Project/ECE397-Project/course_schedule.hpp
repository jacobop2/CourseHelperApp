...
#ifndef course_schedule_hpp
#define course_schedule_hpp
...
StatusCode scheduler( std::vector<std::string> courseNames, ScheduleGroup & bufScheduleGroup );StatusCode scheduler( std::vector<std::string> courseNames, ScheduleGroup & bufScheduleGroup, std::string fpath );
